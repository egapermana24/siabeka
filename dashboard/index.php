                  ...
                  <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item"><a href="index.html">Ini sdfsdfsadfsdfsdfsd Dashboard</a>
                        </li>
                      </ol>
                    </nav>
                  </div>
            ...
            <div class="container-fluid">
                      ...
                      <div class="d-flex align-items-center">
                        <div>
                          <div class="d-inline-flex align-items-center">
                            ...
                            <span class="badge bg-primary font-12 text-white font-weight-medium rounded-pill ms-2 d-lg-block d-md-none">+1.33%</span>
                          </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div>
                          ...
                          <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Mahasiswa Belum Menghitung
                          </h6>
                        </div>
                        <div class="ms-auto mt-md-3 mt-lg-0">
                  ...
                  <div class="card border-end ">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div>
                          <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium">59</h2>
                            <span class="badge bg-danger font-12 text-white font-weight-medium rounded-pill ms-2 d-md-none d-lg-block">39.33%</span>
                          </div>
                          <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Mahasiswa Selesai Menghitung
                          </h6>
                        </div>
                        <div class="ms-auto mt-md-3 mt-lg-0">
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card ">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        <div>
                          <h2 class="text-dark mb-1 font-weight-medium">5.6</h2>
              ...
              <div class="row">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-style-none mb-0">
                        <li>
                          ...
                          <span class="text-muted">Mahasiswa Sudah Menghitung</span>
                          <span class="text-dark float-end font-weight-medium">59</span>
                        </li>
                        <li class="mt-3">
                          <i class="fas fa-circle text-danger font-10 me-2"></i>
                          <span class="text-muted">Mahasiswa Belum Menghitung</span>
                          <span class="text-dark float-end font-weight-medium">20</span>
                        </li>
                        <li class="mt-3">
                          <i class="fas fa-circle text-info font-10 me-2"></i>
                          <span class="text-muted">Total Mahasiswa</span>
                          <span class="text-dark float-end font-weight-medium">79</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-lg-4 col-md-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title mb-4">Semester Mahasiswa</h4>
                      <div class="" style="height:180px">
                        <div id="visitbylocate" style="height:100%"></div>
                      </div>
                      <div class="row mb-3 align-items-center mt-1 mt-5">
                        <div class="col-4 text-end">
                          <span class="text-muted font-14">1 (Satu)</span>
                        </div>
                        <div class="col-5">
                      ...
                      <div class="row mb-3 align-items-center">
                        <div class="col-4 text-end">
                          <span class="text-muted font-14">2 (Dua)</span>
                        </div>
                        <div class="col-5">
                          <div class="progress" style="height: 5px;">
                      ...
                      <div class="row mb-3 align-items-center">
                        <div class="col-4 text-end">
                          <span class="text-muted font-14">3 (Tiga)</span>
                        </div>
                        <div class="col-5">
                          <div class="progress" style="height: 5px;">
                      ...
                      <div class="row align-items-center">
                        <div class="col-4 text-end">
                          <span class="text-muted font-14">4 (Empat)</span>
                        </div>
                        <div class="col-5">
                          <div class="progress" style="height: 5px;">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-4">
                        <h4 class="card-title">Mahasiswa Terbaik</h4>
                        <div class="ms-auto">
                          <div class="dropdown sub-dropdown">
                            <button class="btn btn-link text-muted dropdown-toggle" type="button" id="dd1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <i data-feather="more-vertical"></i>
                        ...
                        <table class="table no-wrap v-middle mb-0">
                          ...
                          <tbody>
                            <tr>
                              <td class="border-top-0 px-2 py-4">
                                <div class="d-flex no-block align-items-center">
                                  <div class="me-3"><img src="../assets/assets/images/users/widget-table-pic1.jpg" alt="user" class="rounded-circle" width="45" height="45" /></div>
                                  <div class="">
                            ...
                            <tr>
                              <td class="px-2 py-4">
                                <div class="d-flex no-block align-items-center">
                                  <div class="me-3"><img src="../assets/assets/images/users/widget-table-pic2.jpg" alt="user" class="rounded-circle" width="45" height="45" /></div>
                                  <div class="">
                            ...
                            <tr>
                              <td class="px-2 py-4">
                                <div class="d-flex no-block align-items-center">
                                  <div class="me-3"><img src="../assets/assets/images/users/widget-table-pic3.jpg" alt="user" class="rounded-circle" width="45" height="45" /></div>
                                  <div class="">
                            ...
                            <tr>
                              <td class="border-bottom-0 px-2 py-4">
                                <div class="d-flex no-block align-items-center">
                                  <div class="me-3"><img src="../assets/assets/images/users/widget-table-pic4.jpg" alt="user" class="rounded-circle" width="45" height="45" /></div>
                                  <div class="">
